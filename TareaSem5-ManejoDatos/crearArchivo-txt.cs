...
namespace TareaSem5_ManejoDatos
{
    class crearArchivo_txt
    {
        ...
        {
            string path = @"C:\Users\harol\source\repos\EjerciciosPrimerComputoC#\TareaSem5-ManejoDatos\registrosMedicos.txt";
            return path;
        }
